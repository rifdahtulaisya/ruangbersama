...
<div class="bg-white rounded-xl p-6 shadow">
            ...
            <tbody>
                ...
                @forelse($monthlyData ?? [] as $data)
                    ...
                    <tr class="border-b border-slate-100 hover:bg-slate-50 transition">
                        ...
                        <td class="text-right py-2 px-3 text-blue-600 font-semibold">{{ number_format($data['loans']) }}</td>
                        <td class="text-right py-2 px-3 text-green-600 font-semibold">{{ number_format($data['returns']) }}</td>
                    </tr>
                @empty
                    <tr>
    ...
    <div class="mt-4 text-xs text-slate-400 border-t border-slate-100 pt-3 text-center">
        <i class="fa-regular fa-chart-bar mr-1"></i> Menampilkan data peminjaman dan pengembalian berdasarkan tahun yang dipilih
    </div>
</div>
