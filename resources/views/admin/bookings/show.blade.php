...
@section('content')
    ...
    <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-xl shadow p-5">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-stone-500 mb-1">Total Peminjaman</p>
                    <p class="text-2xl font-bold text-[#280905]">0</p>
                </div>
        ...
        <!-- Kapasitas Card (Jika ada) -->
        <div class="bg-white rounded-xl shadow p-5">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-stone-500 mb-1">Kapasitas</p>
                    <p class="text-2xl font-bold text-[#280905]">-</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow p-5">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-stone-500 mb-1">Fasilitas</p>
                    <p class="text-2xl font-bold text-[#280905]">-</p>
                </div>
                <div class="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                    <i class="fa-solid fa-wifi text-purple-600 text-xl"></i>
                </div>
            </div>
        </div>
    </div>
