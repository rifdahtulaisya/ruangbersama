<aside id="sidebar"
    ...
    <div class="mt-auto px-6 pb-6">
        <form method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit"
                class="w-full flex items-center justify-center gap-4 px-5 py-3 rounded-xl
                       border border-slate-700 hover:bg-red-500/10 hover:border-red-500/50
